[
    {
        ...
        "text": "I built the standing units in a bit of a rush a couple of months ago in time for a gig. In order to get them built quickly, I used speakers I had bought especially for a new pair of more water-resistant floating units. The cone speakers, for example, had waterproof plastic cones.<br/><br/>.I now want to go ahead and finish the new floating units, so bought some more cheap speakers for the standing ones. I've now fitted the replacements, involving some modification to the structure on each one, and I'm just about happy with the weight distribution. When I first built them, I had the speakers arranged in complete rotational symmetry, which balanced the weight fine, but at the expensed of directionality of the sound. It didn't seem to make any audible difference whether the units were rotating or not, apart from the motor noise.<br/><br/>These units have one planned outing in the midlands at the end of September. Besides that, I might see if I can get them some more gig pre-show features."
    },
    {
        "when": "2024-08-11",
        "heading": "Home demo",
